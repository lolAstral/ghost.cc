...
NotifyLib.prompt('ghost.cc', 'Loading..', 5)
wait(2)
NotifyLib.prompt('ghost.cc', 'Enjoy', 5)
--// minecrafto
local Window = Library.CreateLib("ghost.lua - Aimlock")
...
local UISettings = Window:NewTab("Settings")
--Tabs are finished <3
local Section = Aimlock:NewSection("Aimlock Section")
Section:NewButton("Aimlock", "Q  To lock on people", function()
    NotifyLib.prompt('ghost.cc', '( Press ( P ) To enable aimlock ) Aimlock Loaded Keybind is { Q } ( made by curtz licensed aimlock love u no homo )', 5)
wait(1)
...
Section:NewButton("Silent Aim", "Silent Aim!", function()
     NotifyLib.prompt('FazeWare', 'Silent Aim Enabled! Credits To Someone For Modulev2 ( with license )', 5)
-- // Dependencies
...
Section:NewButton("Silent Aimlock", "Enable", function()
    NotifyLib.prompt('ghost.cc', 'Credits TO Flash For The Lock ( Hes Main Lock But Thats Paid No One Can Deobfuscate Luraph Stay Safe Flash Nigga )' )
...
Section:NewButton("Enable ESP!", "", function()
     NotifyLib.prompt('ghost.cc', 'ESP Enabled!', 5)
